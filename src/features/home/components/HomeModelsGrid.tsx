        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-1 select-none">
            {models.map((m, idx) => (
                <Link key={m.id} to={`/model/${m.id}`} className="group">
                    <article
                        className="relative bg-bg-surface border border-br-subtle rounded-lg overflow-hidden shadow-token-sm hover:shadow-token-xl hover:border-br-primary transition-all duration-300 ease-out w-full cursor-pointer select-none"
                        style={{
                            opacity: 0,
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-bg-page/95 via-bg-page/65 via-bg-page/35 to-transparent flex items-end opacity-0 group-hover:opacity-100 transition-all duration-300 ease-out transform translate-y-4 group-hover:translate-y-0 rounded-lg">
                            <div className="text-white p-3 w-full">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-1">
                                        ...
                                        <div className="w-5 h-5 bg-accent-soft border border-accent/30 rounded-full flex items-center justify-center shadow-accent-sm">
                        ...
                        <div className="absolute inset-0 rounded-lg border border-transparent group-hover:border-accent/35 transition-colors duration-300 pointer-events-none"></div>
                    </article>
                </Link>
            ))}
        </div>
