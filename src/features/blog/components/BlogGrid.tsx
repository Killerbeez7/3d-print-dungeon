    ...
    <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="mb-6 space-y-4">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2 pl-10 border border-br-secondary rounded-lg bg-surface-card text-txt-primary focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent transition-colors"
            />
            <svg
              className="absolute left-3 top-2.5 w-4 h-4 text-txt-muted"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
              ...
              <button
                ...
                className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${
                  selectedTags.includes(tag)
                    ...
                    : "bg-muted text-txt-secondary hover:bg-surface-card"
                }`}
              >
                {tag}
              </button>
      ...
      {filteredPosts.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-txt-secondary">Try adjusting your search terms or filters</p>
        </div>
      )}
