      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {stats.map((stat, index) => (
          ...
          >
            ...
            <div className="text-2xl font-bold text-txt-primary mb-1">{stat.value}</div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h5 className="font-semibold text-txt-primary">{achievement.title}</h5>
                  <p className="text-sm text-txt-secondary">{achievement.description}</p>
