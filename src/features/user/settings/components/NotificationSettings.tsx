...
export const NotificationSettings = () => {
  ...
  const hasChanges =
    ...
    notifications.marketing !== originalNotifications.marketing ||
    notifications.newFollowers !== originalNotifications.newFollowers ||
    notifications.newLikes !== originalNotifications.newLikes ||
    notifications.newComments !== originalNotifications.newComments ||
    notifications.modelUpdates !== originalNotifications.modelUpdates;
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-txt-secondary">
              <p>
                You can customize which notifications you receive. Some important
                account-related notifications cannot be disabled for security reasons.
              </p>
            </div>
          </div>
        </div>
