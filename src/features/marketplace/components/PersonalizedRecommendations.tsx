import { ConsentRequiredFeature } from "@/features/cookies/components/ConsentRequiredFeature";
  ...
  const fallbackContent = (
    <div className="rounded-lg border border-br-subtle bg-bg-section p-6">
      ...
      <p className="mb-4 text-txt-secondary">
        Enable marketing cookies to see personalized recommendations based on your
