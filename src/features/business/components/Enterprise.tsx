    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose max-w-none">
        <p className="text-lg mb-4">
          Discover our enterprise-grade 3D printing solutions tailored for your business
          needs.
        </p>
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          <div className="bg-surface-card p-6 rounded-lg shadow-md">
            ...
            <p>
              Get access to our team of experts for custom 3D printing solutions that
          ...
          <div className="bg-surface-card p-6 rounded-lg shadow-md">
            ...
            <p>
              24/7 dedicated support, priority processing, and enterprise-grade service
              level agreements.
            </p>
          </div>
        </div>
