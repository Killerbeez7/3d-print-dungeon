  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[var(--bg-surface)] text-[var(--txt-primary)] rounded-lg shadow p-6">
        ...
        <p className="mt-2 text-[var(--txt-secondary)]">{currentCategory.description}</p>
      </div>
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        ...
        <Link
          ...
          className="inline-flex items-center px-4 py-2 rounded-lg font-semibold bg-[var(--accent)] text-[var(--txt-highlight)] hover:bg-[var(--accent-hover)] transition"
        >
