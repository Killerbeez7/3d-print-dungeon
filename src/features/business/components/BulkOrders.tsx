      ...
      <div className="prose max-w-none">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          <div className="bg-surface-card p-6 rounded-lg shadow-md">
            ...
            <p>
              Get competitive pricing for large-scale 3D printing orders with our
              volume-based discount system.
            </p>
          </div>
          <div className="bg-surface-card p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">Bulk Processing</h2>
            <p>
              Streamlined processing and shipping for bulk orders with dedicated project
              management.
            </p>
          </div>
        </div>
