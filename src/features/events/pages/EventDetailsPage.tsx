  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
      <div className="mb-6 rounded-lg overflow-hidden shadow">
        <div className="relative w-full aspect-[16/7] bg-surface-card">
          <img
      ...
      {currentEvent.type === "competition" && (
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          {currentEvent.prizes && (
            <div className="bg-surface-card rounded-lg p-4 border border-br-secondary">
      ...
      {currentEvent.type !== "competition" && currentEvent.rules && (
        <div className="mb-6 bg-surface-card rounded-lg p-4 border border-br-secondary">
      ...
      {currentEvent.type === "competition" && (
        <div className="mb-6">
          <div className="bg-surface-card rounded-lg p-6 border border-br-secondary">
