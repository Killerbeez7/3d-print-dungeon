...
export const Explore = () => {
    return (
        <div className="min-h-screen py-8 px-4">
            <h1 className="text-3xl font-bold text-txPrimary mb-6">Explore</h1>
            ...
            <div className="mt-4 space-y-4">
                <h2 className="text-xl font-semibold text-txPrimary">
                    Popular Categories
                </h2>
                <ul className="list-disc list-inside text-txSecondary">
                    <li>Architecture</li>
