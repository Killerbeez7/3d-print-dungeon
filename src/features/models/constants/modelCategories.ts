...
export const MODEL_CATEGORIES: ModelCategory[] = [
  ...
  },
  {
    ...
    name: "Terrains",
    slug: "terrains",
    description: "Environmental pieces like rocks, ruins, hills, and natural scenery.",
    icon: "terrains.svg",
  },
  {
    id: "buildings",
  ...
  },
  {
    ...
    name: "Sci-Fi",
    slug: "sci-fi",
    description: "Science-fiction themed models like mechs, aliens, and tech terrain.",
    icon: "sci-fi.svg",
  },
  {
    id: "modular-tiles",
