...
export const useArtistsSearchPage = () => {
    ...
    // On mount, initialize local query from URL query parameter and set correct URL for artists tab
    useEffect(() => {
        const queryFromURL = searchParams.get("query") || "";
        setLocalQuery(queryFromURL);
        
        // If we're on artists tab and no sort_by parameter exists, add it
        if (activeTab === "artists" && !searchParams.get("sort_by")) {
            setSearchParams({ sort_by: "followers" });
        }
