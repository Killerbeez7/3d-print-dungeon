...
export const PricingForm = ({ modelData, setModelData }) => {
    ...
    const isVerifiedSeller = !!userData?.stripeConnectId;
    ...
    return (
        <div className="space-y-6">
            ...
            {modelData.isPaid && !isVerifiedSeller && (
                    ...
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            <p className="text-sm text-yellow-700">
                                <strong>Action Required:</strong> To sell models, you must complete a one-time seller verification. You will be redirected to Stripe to complete this securely after clicking the final &quot;Upload Model&quot; button.
                            </p>
                        </div>
                    </div>
                </div>
