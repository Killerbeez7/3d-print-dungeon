...
import { MdSave, MdExpandMore, MdExpandLess } from "react-icons/md";
      ...
      const settingsToSave = {
        ...
        scheduledMaintenance: {
          ...
          startTime: settings.scheduledMaintenance.startTime
            ? convertToUTC(settings.scheduledMaintenance.startTime)?.toISOString() ?? null
            : null,
          endTime: settings.scheduledMaintenance.endTime
            ? convertToUTC(settings.scheduledMaintenance.endTime)?.toISOString() ?? null
            : null,
        },
