...
export function ArtistListGrid({ artists }: ArtistListGridProps) {
      ...
      <div className="flex flex-col items-center justify-center py-16 text-center">
        <div className="bg-surface-card rounded-2xl p-8 shadow-sm">
          ...
          <p className="text-txt-secondary text-sm">
            Check back soon as more artists join our community!
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div
      className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6 animate-fade-in"
