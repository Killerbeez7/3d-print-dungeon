      ...
      {collections.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-txt-secondary mb-6">
            Create your first collection to organize your models
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {collections.map((collection) => (
            <div
              key={collection.id}
              className="bg-section rounded-lg overflow-hidden hover:shadow-lg transition-all duration-200"
            >
          ...
          <div className="bg-surface-card rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-br-primary rounded-lg bg-section text-txt-primary focus:border-accent focus:outline-none"
            ...
            <div className="flex gap-3 mt-6">
              <button
                ...
                className="flex-1 px-4 py-2 border border-br-primary rounded-lg text-txt-primary hover:bg-section transition-colors"
              >
                Cancel
              </button>
              <button
