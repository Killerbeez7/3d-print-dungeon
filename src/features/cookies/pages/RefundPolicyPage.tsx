    ...
    <main className="min-h-screen bg-page">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-section rounded-lg p-8">
          <h1 className="text-3xl font-bold text-txt-primary mb-6">Refund Policy</h1>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-txt-secondary mb-4">
              Due to the digital nature of our 3D models, we generally do not offer
              refunds once a model has been downloaded. However, we may consider refunds
            ...
            <p className="text-txt-secondary mb-4">
              Refund requests are typically processed within 3-5 business days. The refund
