      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-br-secondary">
          <thead className="bg-section">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-txt-secondary uppercase tracking-wider">
                Content
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-txt-secondary uppercase tracking-wider">
                Type
          ...
          <tbody className="divide-y divide-br-secondary">
            {filteredReports.map((report) => (
              <tr key={report.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="px-2 py-1 rounded-full text-xs font-medium bg-section text-txt-secondary">
                    {report.contentType}
                  </span>
                </td>
